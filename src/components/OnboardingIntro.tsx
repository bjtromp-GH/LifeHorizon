                ...
                >
                  {titleLetters.map((char, index) => (
                    <motion.span
                      key={index}
                      variants={letterVars}
                      className={`text-[32px] min-[375px]:text-[38px] min-[415px]:text-[42px] sm:text-7xl font-sans font-black tracking-tighter select-none inline-block ${char === " " ? "w-2 sm:w-4" : "text-white"}`}
                      style={{
