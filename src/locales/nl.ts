export const nl = {
  ...
  mobileContainer: {
    ...
    ratingSpeechWithName: "Zo {{name}}, dat was best interessant toch? Hoeveel sterren geef je deze app?",
    ratingSpeechWithoutName: "Zo, dat was best interessant toch? Hoeveel sterren geef je deze app?",
    ratingFeedback: "Bedankt voor je feedback!",
    endModalThanks: "Bedankt voor het doorlopen van jouw Life Horizon. Je hebt nu alle inzichten om met vertrouwen richting financiële vrijheid te sturen.",
    endModalClose: "Sluiten & Terug naar start",
