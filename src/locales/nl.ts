export const nl = {
  ...
  onboarding: {
    ...
    revealScreen: {
      ...
      years: "jaar",
      alreadyLived: "Al geleefd ({{percent}}%)",
      openDashboard: "NAAR HET DASHBOARD"
    },
  ...
  mobileContainer: {
    ...
    totalLabel: "Totaal",
    modelInspiration1: "Als inspiratie stellen wij een optimaal model voor: ",
    modelInspiration2: "Het 25 / 50 / 25 model.",
