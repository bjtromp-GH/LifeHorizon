...
export const en: Translations = {
  ...
  mobileContainer: {
    ...
    ratingSpeechWithName: "Well {{name}}, that was quite interesting, right? How many stars do you give this app?",
    ratingSpeechWithoutName: "Well, that was quite interesting, right? How many stars do you give this app?",
    ratingFeedback: "Thanks for your feedback!",
    endModalThanks: "Thank you for completing your Life Horizon. You now have all the insights to steer towards financial freedom with confidence.",
    endModalClose: "Close & Back to start",
