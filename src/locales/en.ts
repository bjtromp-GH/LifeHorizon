...
export const en: Translations = {
  ...
  mobileContainer: {
    ...
    financialRunwayTitle: "Your Financial Runway",
    financialRunwayQuestion: "Do you want to know how you can achieve the 25 / 50 / 25 model or better?",
    financialRunwayDesc: "We have built another app that helps you map out your financial runway and achieve your goals: the Financial Runway App.",
